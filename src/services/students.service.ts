...
const getAll = async (school_id: string, per_page = 10, page = 1, filterBy = '', filterValue = '', filterType = '') =>
  api.get(
    `/${school_id}/students?per_page=${per_page}&page=${page}&orderBy=name&orderType=ASC${
